...
public class GuiCreate {
		...
		private class CustomerDataTable extends JPanel {		
			...
			String[] columns = new String [] {
					"Name" , "Order" , "Price £","Server", "Served"
			};
			
			// stores a data object that's representitive of the final outlook
			// this will need to be changed
			Object [][] data = new Object[][] {
				{"Mario", "Cake and Chips", 5.20 ,"Wario",false},
				{"Bob", "A sandwich", 3.20, "Luigi",false}
			};
			// defines the array of the table and types i.e String int 
			// THIS NEEDS TO BE CHANGED DEPENDING UPON ARRAY SIZE AND TYPE otherwise it breaks in half with 
			// a error on line 1000 that doesnt address this being the issue
			final Class[] columnCla = new Class[] {
					String.class, String.class, Double.class,String.class, Boolean.class
			};
		...
		// this is a stand in for the manager class
